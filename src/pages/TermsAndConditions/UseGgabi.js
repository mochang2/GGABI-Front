...
import { ContentForUsingGgabi } from "../../components/Auth/AuthDetails/SignupAgreementContent"



const UseGgabi = (props) => {
  return (
            ...
            <Col xs="12">
              <Card className="terms-and-conditions-nav-bar-wrapper">
                <Breadcrumbs aria-label="breadcrumb" separator="|">
                  ...
                  <Link to={LinkTo.receivePromotion} className="inactive">
                    프로모션 수신 약관
                  </Link>
                </Breadcrumbs>
              </Card>
