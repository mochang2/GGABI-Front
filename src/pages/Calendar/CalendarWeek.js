          ...
          <Row xs={12}>
            ...
            <Card>
              <CardBody>
                ...
                locale={localeKo} initialView="timeGridWeek" timeZone="Asia/Seoul" themeSystem="bootstrap"
                headerToolbar={{start:"prev,next storeBtn", center:"title", end:"yearBtn,monthBtn,timeGridWeek,dayBtn"}}
...
export default withRouter(CalendarWeek)